...
describe('Weather Service Unit Tests (Mocked)', () => {
  ...
  describe('getWeatherData - API Error Handling', () => {
    ...
    it('should handle network errors', async () => {
      ...
      await expect(getWeatherData('10001')).rejects.toThrow('Weather service is currently unreachable');
    });
    ...
    it('should handle unexpected errors', async () => {
      ...
      await expect(getWeatherData('10001')).rejects.toThrow('An internal error occurred while fetching location data');
    });
  });
